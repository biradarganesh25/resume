...
\begin{itemize}[noitemsep,nolistsep,leftmargin=*]
	...
	\item Read Designing Data-Intensive Applications, which helped me understand intricacies of distributed systems and make better design choices (for e.g choices involving trade-offs between avaliability and consistency)
...
\item {Technologies: Azure, GCP, Python, C, Ansible\\}
\end{itemize}
...
\item{Technologies: Azure, AWS, GCP, C, Python, Ansible, Perl \\}
\end{itemize}
...
\item {Techonologies: Docker, Postman, Jupyter Notebooks, Spark, Rasa, Go-Kit, Kubernetes, Envoy, AWS, GCP, Azure, Numpy, Pandas, PyTorch, Seaborn, CUDA, OpenMP}
